...
namespace NotificationService
{
    public class NotificationConstants
    {
        ...
        /// </summary>
        public const string IncomingCallingMsgText = "incomingCallingMsgText";

        /// <summary>
        /// Key for getting mcr message text.
        /// </summary>
        public const string McrMsgText = "mcrMsgText";
        ...
        /// </summary>
        public const string IosIncomingCallingTone = "iosIncomingCallingTone";

        /// <summary>
        /// A constant string for accessing the notification message value in dictionary.
        /// </summary>
        public const string Alert = "alert";

        /// <summary>
        /// A constant string for accessing the badge value in dictionary.
        /// </summary>
        public const string Badge = "badge";

        /// <summary>
        ///A constant key for getting the MCR count value in dictionary.
        /// </summary>
        public const string McrCount = "mcrCount";
