...
namespace NeeoPushNotificationService.Notification.Test.Notification
{
    /// <summary>
    ...
    public sealed class NotificationManager
    {
        ...
        private void ChannelDestroyed(object sender)
        {
            ...
            LogManager.CurrentInstance.InfoLogger.LogInfo(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType, "Channel destroyed on " + DateTime.Now, System.Reflection.MethodBase.GetCurrentMethod().Name);
        }
        /// <summary>
        ...
        {
            LogManager.CurrentInstance.ErrorLogger.LogError(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType, "Device subscription changed. OldSubID: " + oldSubscriptionId + " --" + "NewSubID: " + newSubscriptionId, System.Reflection.MethodBase.GetCurrentMethod().Name);
        }
        /// <summary>
        ...
        private bool IsProductionCertificate()
        {
            const string certificateTypeKey = "appleCertificateType";
            string certificateType = ConfigurationManager.AppSettings[certificateTypeKey];
            if (certificateType == "debug")
            {
                return false;
            }
            ...
            throw new ConfigurationErrorsException("appleCertificateType value is invalid!");
        }
    }
}
